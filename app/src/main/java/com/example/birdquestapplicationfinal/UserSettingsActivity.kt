...
class UserSettingsActivity : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_user_settings_activity, container, false)
    ...
    private fun toLight() {
        ...
        val newUnselectedColor = ContextCompat.getColor(requireContext(), R.color.app_background2)
        val unselectedColorStateList = ColorStateList.valueOf(newUnselectedColor)
